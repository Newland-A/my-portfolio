    ...
    return (
      <div>
        <List bulleted>
            ...
            <List.Item>Share my knowledge with others to inspire them to always follow their dreams matter how many side roads have to be taken to accomplish the end goal.</List.Item>
